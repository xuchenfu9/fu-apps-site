...
export const ui: Record<Locale, UiCopy> = {
  "zh-Hans": {
    ...
    viewApp: "查看应用", features: "功能", screenshots: "应用截图", documents: "应用文档", privacy: "隐私政策", support: "用户支持", terms: "服务条款", appStore: "App Store", openAppStore: "前往 App Store", storefront: "App Store 地区", language: "语言", nowAvailable: "现可下载", planned: "计划发布", availableIn: (region) => `当前跳转至 ${region} App Store`, releasePlanned: (region) => `${region} 版本计划发布，届时将使用当地名称`, notFoundTitle: "页面未找到", notFoundBody: "这个链接可能已更新，或页面暂时不可用。", returnHome: "返回应用首页", footer: "为 Apple 平台设计的独立应用"
  },
  "zh-Hant": {
    home: "首頁", allApps: "所有 App", galleryEyebrow: "FU apps", galleryTitle: "為日常留一處好用的空間。", galleryBody: "一組專注於記錄、整理、連結與輕鬆時刻的 Apple 平台 App。",
    viewApp: "查看 App", features: "功能", screenshots: "App 截圖", documents: "App 文件", privacy: "隱私政策", support: "用戶支援", terms: "服務條款", appStore: "App Store", openAppStore: "前往 App Store", storefront: "App Store 地區", language: "語言", nowAvailable: "現可下載", planned: "計畫發布", availableIn: (region) => `目前跳轉至 ${region} App Store`, releasePlanned: (region) => `${region} 版本計畫發布，屆時將使用當地名稱`, notFoundTitle: "找不到頁面", notFoundBody: "這個連結可能已更新，或頁面暫時無法使用。", returnHome: "返回 App 首頁", footer: "為 Apple 平台設計的獨立 App"
  },
  en: {
    ...
    viewApp: "View app", features: "Features", screenshots: "Screens", documents: "App documents", privacy: "Privacy Policy", support: "User Support", terms: "Terms of Service", appStore: "App Store", openAppStore: "View on the App Store", storefront: "App Store region", language: "Language", nowAvailable: "Available now", planned: "Planned release", availableIn: (region) => `Opening the ${region} App Store`, releasePlanned: (region) => `Planned for ${region}; the local name will appear when released`, notFoundTitle: "Page not found", notFoundBody: "This link may have moved, or the page is not available yet.", returnHome: "Return to apps", footer: "Independent apps for Apple platforms"
  },
  ja: {
    ...
    viewApp: "アプリを見る", features: "機能", screenshots: "スクリーン", documents: "アプリの文書", privacy: "プライバシーポリシー", support: "ユーザーサポート", terms: "利用規約", appStore: "App Store", openAppStore: "App Store で見る", storefront: "App Store の地域", language: "言語", nowAvailable: "配信中", planned: "配信予定", availableIn: (region) => `${region} の App Store を開きます`, releasePlanned: (region) => `${region} 向けに配信予定です。配信時に現地名が表示されます`, notFoundTitle: "ページが見つかりません", notFoundBody: "リンクが変更されたか、まだ利用できないページです。", returnHome: "アプリ一覧に戻る", footer: "Apple プラットフォームのためのインディペンデントアプリ"
  },
  ko: {
