...
export const ui: Record<Locale, UiCopy> = {
  "zh-Hans": {
    ...
    viewApp: "查看应用", features: "功能", currentVersion: "当前版本", latestUpdate: "最近更新", version: "版本", screenshots: "应用截图", documents: "应用文档", privacy: "隐私政策", support: "用户支持", terms: "服务条款", marketing: "营销条款", appStore: "App Store", openAppStore: "前往 App Store", storefront: "App Store 地区", language: "语言", nowAvailable: "现可下载", planned: "计划发布", releasePreparing: "上架中", availableIn: (region) => `当前跳转至 ${region} App Store`, releasePlanned: (region) => `${region} 版本计划发布，届时将使用当地名称`, notFoundTitle: "页面未找到", notFoundBody: "这个链接可能已更新，或页面暂时不可用。", returnHome: "返回应用首页", footer: "为 Apple 平台设计的独立应用"
  },
  "zh-Hant": {
    home: "首頁", allApps: "所有 App", galleryEyebrow: "FU apps", galleryTitle: "為日常留一處好用的空間。", galleryBody: "一組專注於記錄、整理、連結與輕鬆時刻的 Apple 平台 App。",
    viewApp: "查看 App", features: "功能", currentVersion: "目前版本", latestUpdate: "最近更新", version: "版本", screenshots: "App 截圖", documents: "App 文件", privacy: "隱私政策", support: "用戶支援", terms: "服務條款", marketing: "行銷條款", appStore: "App Store", openAppStore: "前往 App Store", storefront: "App Store 地區", language: "語言", nowAvailable: "現可下載", planned: "計畫發布", releasePreparing: "上架中", availableIn: (region) => `目前跳轉至 ${region} App Store`, releasePlanned: (region) => `${region} 版本計畫發布，屆時將使用當地名稱`, notFoundTitle: "找不到頁面", notFoundBody: "這個連結可能已更新，或頁面暫時無法使用。", returnHome: "返回 App 首頁", footer: "為 Apple 平台設計的獨立 App"
  },
  en: {
  ...
  ko: {
    ...
    viewApp: "앱 보기", features: "기능", currentVersion: "현재 버전", latestUpdate: "최근 업데이트", version: "버전", screenshots: "화면", documents: "앱 문서", privacy: "개인정보 처리방침", support: "사용자 지원", terms: "서비스 약관", marketing: "마케팅 약관", appStore: "App Store", openAppStore: "App Store에서 보기", storefront: "App Store 지역", language: "언어", nowAvailable: "현재 다운로드 가능", planned: "출시 예정", releasePreparing: "출시 준비 중", availableIn: (region) => `${region} App Store를 엽니다`, releasePlanned: (region) => `${region} 출시 예정이며 출시 후 현지 이름이 표시됩니다`, notFoundTitle: "페이지를 찾을 수 없습니다", notFoundBody: "링크가 변경되었거나 아직 사용할 수 없는 페이지입니다.", returnHome: "앱 목록으로 돌아가기", footer: "Apple 플랫폼을 위한 독립 앱"
  }
};
