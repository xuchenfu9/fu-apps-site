...
export const appstorylineLegal: AppLegalDocuments = {
  "zh-Hans": {
    privacy: document("隐私政策", [
      { title: "运营者与范围", paragraphs: ["App Screenshot Tools（中文名：上架图工具）由付书艺 / Shuyi Fu 独立开发和运营。本政策适用于你在受支持的 Apple 设备上使用本应用。", "应用面向 App Store 截图和宣传图排版，不要求创建账户。"] },
    ...
    support: document("用户支持", [
      { title: "获得帮助", paragraphs: ["App Screenshot Tools 用于在设备本地制作 App Store 截图和宣传图。支持范围包括模板选择、截图导入、文字与背景编辑、项目保存、PNG 导出和 ZIP 导出。"] },
      { title: "问题报告", paragraphs: ["请提供应用版本、设备型号、系统版本、问题所在步骤和最小复现步骤。发送截图或项目文件前，请删除不必要的个人资料和未获授权的内容。"] },
      { title: "付款问题", paragraphs: ["App Screenshot Tools 是一次性付费下载，不提供应用内订阅或应用内购买。购买、退款和账单由实际下载平台按其规则处理；开发者无法代替平台处理付款或退款。"] },
      { title: "联系我们", paragraphs: ["支持邮箱：fxcpxs@163.com。请不要发送 Apple ID 密码、支付凭据或与问题无关的私人图片。"] }
    ]),
    terms: document("服务条款", [
      { title: "许可", paragraphs: ["下载、安装或使用 App Screenshot Tools，即表示你同意本条款。你获得在自己拥有或控制的受支持 Apple 设备上使用本应用的有限、非独占、不可转让许可。"] },
    ...
    marketing: document("营销条款", [
      { title: "产品主张", paragraphs: ["一次购买，无订阅。你的截图始终留在设备上。App Screenshot Tools 让你在本地选择模板、导入截图、编辑文字与背景，并导出适合继续检查和提交的 PNG 或 ZIP 文件。"] },
  ...
  "zh-Hant": {
    privacy: document("隱私政策", [
      { title: "營運者與範圍", paragraphs: ["App Screenshot Tools（中文名：上架圖工具）由付書藝 / Shuyi Fu 獨立開發和營運。本政策適用於你在支援的 Apple 裝置上使用本 App。", "App 用於 App Store 截圖和宣傳圖排版，不要求建立帳戶。"] },
    ...
    support: document("用戶支援", [
      { title: "取得協助", paragraphs: ["App Screenshot Tools 用於在裝置本機製作 App Store 截圖和宣傳圖。支援範圍包括範本選擇、截圖匯入、文字與背景編輯、專案保存、PNG 輸出和 ZIP 輸出。"] },
      { title: "問題回報", paragraphs: ["請提供 App 版本、裝置型號、系統版本、問題所在步驟和最小重現步驟。傳送截圖或專案檔案前，請刪除不必要的個人資料和未獲授權的內容。"] },
      { title: "付款問題", paragraphs: ["App Screenshot Tools 是一次性付費下載，不提供 App 內訂閱或 App 內購買。購買、退款和帳單由實際下載平台按其規則處理；開發者無法代替平台處理付款或退款。"] },
      { title: "聯絡我們", paragraphs: ["支援信箱：fxcpxs@163.com。請不要傳送 Apple ID 密碼、付款憑據或與問題無關的私人照片。"] }
    ]),
    terms: document("服務條款", [
      { title: "授權", paragraphs: ["下載、安裝或使用 App Screenshot Tools，即表示你同意本條款。你取得在自己擁有或控制的支援 Apple 裝置上使用本 App 的有限、非專屬、不可轉讓授權。"] },
    ...
    marketing: document("行銷條款", [
      { title: "產品主張", paragraphs: ["一次購買，無訂閱。你的截圖始終留在裝置上。App Screenshot Tools 讓你在本機選擇範本、匯入截圖、編輯文字與背景，並輸出適合繼續檢查和提交的 PNG 或 ZIP 檔案。"] },
  ...
  en: {
    privacy: document("Privacy Policy", [
      { title: "Operator and scope", paragraphs: ["App Screenshot Tools, also known in Chinese as 上架图工具, is independently developed and operated by 付书艺 / Shuyi Fu. This policy applies when you use the app on a supported Apple device.", "The app prepares App Store screenshots and promotional layouts. It does not require an account."] },
    ...
    support: document("User Support", [
      { title: "Get help", paragraphs: ["App Screenshot Tools makes App Store screenshots and promotional layouts on your device. Support covers template selection, screenshot import, text and background editing, project saving, PNG export, and ZIP export."] },
      ...
      { title: "Payment questions", paragraphs: ["App Screenshot Tools is a one-time paid download and does not provide subscriptions or in-app purchases. The actual download platform handles payment, refunds, and billing under its own rules; the developer cannot process them on the platform's behalf."] },
    ...
    terms: document("Terms of Service", [
      { title: "License", paragraphs: ["By downloading, installing, or using App Screenshot Tools, you agree to these terms. You receive a limited, non-exclusive, non-transferable license to use the app on supported Apple devices that you own or control."] },
    ...
    marketing: document("Marketing Terms", [
      { title: "Product promise", paragraphs: ["One payment. No subscription. Your screenshots stay on your device. App Screenshot Tools lets you choose a template, import screenshots, edit text and backgrounds locally, and export PNG or ZIP files for further review and submission."] },
  ...
  ja: {
    privacy: document("プライバシーポリシー", [
      { title: "運営者と対象", paragraphs: ["App Screenshot Tools（中国語名：上架图工具）は、付书艺 / Shuyi Fu が独立して開発・運営しています。本ポリシーは、対応する Apple デバイスで本アプリを使用するときに適用されます。", "本アプリは App Store のスクリーンショットと宣伝用レイアウトを作成し、アカウントを要求しません。"] },
    ...
    support: document("ユーザーサポート", [
      { title: "サポート範囲", paragraphs: ["App Screenshot Tools はデバイス上で App Store スクリーンショットと宣伝用レイアウトを作成します。テンプレート選択、スクリーンショット読み込み、文字・背景編集、プロジェクト保存、PNG・ZIP 書き出しをサポートします。"] },
      ...
      { title: "支払いについて", paragraphs: ["App Screenshot Tools は一度きりの有料ダウンロードで、サブスクリプションとアプリ内課金はありません。購入、返金、請求は実際のダウンロードプラットフォームがその規則に従って処理します。"] },
      { title: "連絡先", paragraphs: ["サポートメール：fxcpxs@163.com。Apple ID のパスワード、支払い情報、問題に関係のない個人的な画像は送らないでください。"] }
    ]),
    terms: document("利用規約", [
      { title: "ライセンス", paragraphs: ["App Screenshot Tools をダウンロード、インストール、または使用することで、本規約に同意したものとします。あなたが所有または管理する対応 Apple デバイスで使用する、限定的、非独占的、譲渡不可のライセンスを付与します。"] },
    ...
    marketing: document("マーケティング規約", [
      { title: "製品の約束", paragraphs: ["一度の購入で、サブスクリプションなし。スクリーンショットはデバイス内に保管されます。App Screenshot Tools はテンプレートを選び、スクリーンショットを読み込み、文字と背景をローカルで編集し、PNG または ZIP を書き出せます。"] },
  ...
  ko: {
    privacy: document("개인정보 처리방침", [
      { title: "운영자와 적용 범위", paragraphs: ["App Screenshot Tools(중국어 이름: 上架图工具)은 付书艺 / Shuyi Fu가 독립적으로 개발하고 운영합니다. 이 정책은 지원되는 Apple 기기에서 앱을 사용할 때 적용됩니다.", "앱은 App Store 스크린샷과 홍보용 레이아웃을 만들며 계정을 요구하지 않습니다."] },
    ...
    support: document("사용자 지원", [
      { title: "도움 받기", paragraphs: ["App Screenshot Tools은 기기에서 App Store 스크린샷과 홍보용 레이아웃을 만듭니다. 템플릿 선택, 스크린샷 가져오기, 텍스트·배경 편집, 프로젝트 저장, PNG·ZIP 내보내기를 지원합니다."] },
      { title: "문제 신고", paragraphs: ["앱 버전, 기기 모델, 시스템 버전, 문제가 발생한 단계, 최소 재현 절차를 알려 주세요. 스크린샷이나 프로젝트를 보내기 전에 불필요한 개인정보와 권한 없는 콘텐츠를 제거하세요."] },
      { title: "결제 문의", paragraphs: ["App Screenshot Tools은 한 번 구매하는 유료 다운로드이며 구독이나 앱 내 구매를 제공하지 않습니다. 결제, 환불, 청구는 실제 다운로드 플랫폼의 규칙에 따라 처리됩니다."] },
      { title: "문의하기", paragraphs: ["지원 이메일: fxcpxs@163.com. Apple ID 비밀번호, 결제 정보 또는 문제와 무관한 사적인 이미지를 보내지 마세요."] }
    ]),
    terms: document("서비스 약관", [
      { title: "사용권", paragraphs: ["App Screenshot Tools을 다운로드, 설치 또는 사용하면 이 약관에 동의하는 것입니다. 사용자가 소유하거나 관리하는 지원 Apple 기기에서 사용할 수 있는 제한적이고 비독점적이며 양도할 수 없는 사용권을 제공합니다."] },
    ...
    marketing: document("마케팅 약관", [
      { title: "제품 약속", paragraphs: ["한 번 구매하고 구독 없이 사용하세요. 스크린샷은 기기에 보관됩니다. App Screenshot Tools은 템플릿을 선택하고 스크린샷을 가져오며 텍스트와 배경을 기기에서 편집하고 PNG 또는 ZIP으로 내보냅니다."] },
